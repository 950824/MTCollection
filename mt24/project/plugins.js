var plugins_bb40132b_638b_4a9f_b028_d3fe47acc8d1 = 
{
    ...
    "更新怪物数据": function () {
	// 在此增加新插件
	//已经作古的事件，被更改怪物数据事件完全替代，这里是移植用
	core.plugin.gengxinguaiwushuju = function () {
		if (!core.getBlock(6, 6, "MT16")) {
			...
			core.material.enemys.darkKnight.exp = 100;
			...
			core.material.enemys.ghostSkeleton.exp = 100;
			...
			core.material.enemys.blackMagician.exp = 93;
			...
			core.material.enemys.redKing.exp = 133;
		}
		if (!core.getBlock(6, 7, "MT19")) {
			...
			core.material.enemys.vampire.exp = 275;
		}
		if (!core.getBlock(6, 2, "MT21")) {
			...
			core.material.enemys.redKing.exp = 166;
			...
			core.material.enemys.darkKnight.exp = 125;
			...
			core.material.enemys.ghostSkeleton.exp = 125;
			...
			core.material.enemys.blackMagician.exp = 116;
			...
			core.material.enemys.vampire.exp = 343;
		}
	}
